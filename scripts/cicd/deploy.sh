...
if os.environ.get("ACCESS_KEY_SERVICE_IMAGE_URI"):
    desired["access-keys"] = os.environ["ACCESS_KEY_SERVICE_IMAGE_URI"]
if os.environ.get("WALLET_SERVICE_IMAGE_URI"):
    desired["wallet"] = os.environ["WALLET_SERVICE_IMAGE_URI"]
if os.environ.get("TRANSFER_SERVICE_IMAGE_URI"):
    desired["transfer"] = os.environ["TRANSFER_SERVICE_IMAGE_URI"]
if os.environ.get("PRICING_SERVICE_IMAGE_URI"):
    desired["pricing"] = os.environ["PRICING_SERVICE_IMAGE_URI"]
...
TASK_DEFINITION_PAYLOAD="${TASK_DEFINITION_PAYLOAD}" IMAGE_URI="${IMAGE_URI}" API_SERVICE_IMAGE_URI="${API_SERVICE_IMAGE_URI:-}" USER_SERVICE_IMAGE_URI="${USER_SERVICE_IMAGE_URI:-}" AUTHORISATION_SERVICE_IMAGE_URI="${AUTHORISATION_SERVICE_IMAGE_URI:-}" ACADEMY_SERVICE_IMAGE_URI="${ACADEMY_SERVICE_IMAGE_URI:-}" ORGANISATION_SERVICE_IMAGE_URI="${ORGANISATION_SERVICE_IMAGE_URI:-}" COURSE_SERVICE_IMAGE_URI="${COURSE_SERVICE_IMAGE_URI:-}" BOOKING_SERVICE_IMAGE_URI="${BOOKING_SERVICE_IMAGE_URI:-}" PAYMENT_SERVICE_IMAGE_URI="${PAYMENT_SERVICE_IMAGE_URI:-}" SUBSCRIPTION_SERVICE_IMAGE_URI="${SUBSCRIPTION_SERVICE_IMAGE_URI:-}" NOTIFICATION_SERVICE_IMAGE_URI="${NOTIFICATION_SERVICE_IMAGE_URI:-}" ANALYTICS_SERVICE_IMAGE_URI="${ANALYTICS_SERVICE_IMAGE_URI:-}" ACCESS_KEY_SERVICE_IMAGE_URI="${ACCESS_KEY_SERVICE_IMAGE_URI:-}" WALLET_SERVICE_IMAGE_URI="${WALLET_SERVICE_IMAGE_URI:-}" TRANSFER_SERVICE_IMAGE_URI="${TRANSFER_SERVICE_IMAGE_URI:-}" PRICING_SERVICE_IMAGE_URI="${PRICING_SERVICE_IMAGE_URI:-}" TASK_DEFINITION_FILE="${TASK_DEFINITION_FILE}" python3 - <<'PY'
import json
import os
...
if os.environ.get("ACCESS_KEY_SERVICE_IMAGE_URI"):
    image_by_container["access-keys"] = os.environ["ACCESS_KEY_SERVICE_IMAGE_URI"]
if os.environ.get("WALLET_SERVICE_IMAGE_URI"):
    image_by_container["wallet"] = os.environ["WALLET_SERVICE_IMAGE_URI"]
if os.environ.get("TRANSFER_SERVICE_IMAGE_URI"):
    image_by_container["transfer"] = os.environ["TRANSFER_SERVICE_IMAGE_URI"]
if os.environ.get("PRICING_SERVICE_IMAGE_URI"):
    image_by_container["pricing"] = os.environ["PRICING_SERVICE_IMAGE_URI"]
