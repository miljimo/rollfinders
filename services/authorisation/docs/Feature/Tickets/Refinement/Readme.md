...
1. [Ticket001 - Finalise Authorisation Service Boundary And Permission Catalog](Ticket001FinaliseAuthorisationBoundaryAndPermissionCatalog.md)
2. [Ticket002 - Bootstrap Authorisation Service Runtime](Ticket002BootstrapAuthorisationServiceRuntime.md)
3. [Ticket003 - Define Authorisation OpenAPI Contract](Ticket003DefineAuthorisationOpenApiContract.md)
4. [Ticket004 - Implement Authorisation Database Schema](Ticket004ImplementAuthorisationDatabaseSchema.md)
5. [Ticket005 - Implement Permission And Role Management APIs](Ticket005ImplementPermissionAndRoleManagementApis.md)
6. [Ticket006 - Implement User Permission Assignment APIs](Ticket006ImplementUserPermissionAssignmentApis.md)
7. [Ticket007 - Implement Authorize And Effective Permissions APIs](Ticket007ImplementAuthorizeAndEffectivePermissionsApis.md)
8. [Ticket008 - Translate Existing Users Service Authorisation Data](Ticket008TranslateExistingUsersServiceAuthorisationData.md)
9. [Ticket009 - Cut Over Permission Tables To Authorisation Source Of Truth](Ticket009CutOverPermissionTablesToAuthorisationSourceOfTruth.md)
10. [Ticket010 - Add RollFinders Authorisation Client And Compatibility Helper](Ticket010AddRollFindersAuthorisationClientAndCompatibilityHelper.md)
11. [Ticket011 - Replace RollFinders Hardcoded Role Guards](Ticket011ReplaceRollFindersHardcodedRoleGuards.md)
12. [Ticket012 - Enforce Authorisation In Domain Services](Ticket012EnforceAuthorisationInDomainServices.md)
13. [Ticket013 - Remove Authorisation Ownership From Users Service](Ticket013RemoveAuthorisationOwnershipFromUsersService.md)
14. [Ticket014 - Add Authorisation Regression Suite And Migration Contracts](Ticket014AddAuthorisationRegressionSuiteAndMigrationContracts.md)
