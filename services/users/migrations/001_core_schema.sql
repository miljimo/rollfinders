...
\ir tables/000_roles_and_privileges.sql
...
\ir functions/009_role_exists.sql
\ir functions/011_user_has_privilege.sql
...
\ir backfills/001_rollfinders_public_user_credentials.sql
