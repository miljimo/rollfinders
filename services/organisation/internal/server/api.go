...
func (s *server) listOrganisations(w http.ResponseWriter, r *http.Request) {
	...
	organisations, err := s.repo.listOrganisations(r.Context())
	if err != nil {
	...
	writeJSON(w, http.StatusOK, map[string]any{"organisations": organisations})
}
...
func (s *server) listApplications(w http.ResponseWriter, r *http.Request) {
	...
	applications, err := s.repo.listApplications(r.Context())
	if err != nil {
...
func (s *server) listApplicationServices(w http.ResponseWriter, r *http.Request) {
	...
	services, err := s.repo.listApplicationServices(r.Context(), applicationID)
	if err != nil {
