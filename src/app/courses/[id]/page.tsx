      ...
      <section className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
        ...
        <dl className="mt-6 grid gap-3 rounded-lg border border-stone-200 bg-white p-4 text-sm text-stone-700 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <dt className="font-bold text-stone-950">Address</dt>
        ...
        {canCheckout ? (
          <section className="mt-6 rounded-lg border border-teal-200 bg-teal-50 p-4 shadow-sm">
            <h2 className="text-xl font-black text-stone-950">{checkoutMode === "donation" ? "Support this course" : "Secure your place"}</h2>
            <p className="mt-2 text-sm leading-6 text-stone-700">{checkoutMode === "donation" ? "Choose the amount you want to donate. Payments are handled securely by Stripe." : "Pay securely through the RollFinders payment service. Card details are handled by Stripe."}</p>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <AnalyticsClickTracker eventName="commercial_intent_clicked" metadata={{ actionType: "academy_details", academyId: event.academyId, external: false, courseId: event.id, sourcePage: "course_profile" }}>
