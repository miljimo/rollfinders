...
export const metadata: Metadata = {
  title: "Privacy Policy | RollFinder",
  description: "Read how RollFinder collects, uses, stores, and protects personal data, including user account information, cookies, analytics, and GDPR rights.",
...
export default function PrivacyPolicyPage() {
  return (
    <StaticPageShell>
      <LegalPage title="Privacy Policy" intro="This policy explains how RollFinder handles personal data for users, academy owners, and visitors.">
        <Section title="Data We Collect">
          <p>We may collect account details such as name, email address, login activity, academy claim information, and messages sent to RollFinder.</p>
        ...
        <Section title="Cookies and Analytics">
          <p>RollFinder may use essential cookies for authentication and security. Analytics may be used to understand aggregate usage, search demand, and map interactions.</p>
        </Section>
        <Section title="Data Retention">
          <p>Account and administrative records are kept while they are needed to operate RollFinder, meet legal obligations, resolve disputes, and protect platform integrity.</p>
        </Section>
