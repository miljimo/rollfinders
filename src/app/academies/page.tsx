  ...
  return (
    <PageShell>
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <p className="mt-2 text-stone-700">Search by academy name, city, or postcode.</p>
        <div className="mt-5"><SearchForm action="/academies" query={q} placeholder="e.g. Hackney, SW9, Roger Gracie" /></div>
