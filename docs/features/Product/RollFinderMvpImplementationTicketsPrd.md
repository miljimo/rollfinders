...
* `docs/features/Administration/AdminUserManagement.md`
* `docs/features/Platform/PublicBusinessInformation.md`
* Current administration/user role PRDs under `docs/features/Administration/Users/`
...
* New or existing docs under `docs/features/Product/`
...
* `docs/features/Product/RollFinderMvpPrd.md` or separate technical decision record
* Deployment docs under `docs/features/Deployment/` or `docs/architecture/`
