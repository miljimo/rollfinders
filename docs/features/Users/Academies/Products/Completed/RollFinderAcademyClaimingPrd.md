...
* Platform-added academy claim invitation email, with detailed email format requirements in `docs/features/Communications/Email/AcademyClaimEmails/Products/Completed/AcademyClaimInvitationEmailPrd.md`.
* Admin audit logging.
