...
| --- | --- | --- |
| `payment.client.create` | Create a client integration record. | core/application |
| `payment.client.read` | Read a client integration record. | core/application |
| `payment.client.update` | Update client callback URLs, origins, or metadata. | core/application |
...
| `payment.settlement.hold` | Place a settlement hold. | core/payee |
| `payment.settlement.release` | Release a settlement hold. | core/payee |
...
| `payment.audit.read` | Read payment audit events. | client/core/resource |
