...
* `apps/backend_api/migrations/payments/001_core_schema.sql`
...
* `docs/services/courses/Products/Reviewing/CourseCreationAndManagementPrd.md`
* `docs/services/courses/Tickets/README.md`
...
* OpenAPI 3 contract under `docs/services/courses/api/OpenApi.yaml`
