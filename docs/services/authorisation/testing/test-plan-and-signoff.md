...
- `docs/services/authorisation/testing/migrated-role-guard-areas.json`
...
1. Add its path to `docs/services/authorisation/testing/migrated-role-guard-areas.json`.
