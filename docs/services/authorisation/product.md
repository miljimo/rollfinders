...
| `authorisation.permission.read` | Read a permission definition. | core/organisation/application |
| `authorisation.permission.search` | List/search permission definitions. | core/organisation/application |
...
| `authorisation.role.create` | Create a role bundle. | core/organisation/application |
| `authorisation.role.read` | Read a role bundle. | core/organisation/application |
| `authorisation.role.search` | List/search role bundles. | core/organisation/application |
| `authorisation.role.update` | Update role metadata, level, or assignability. | core/organisation/application |
| `authorisation.role.delete` | Delete/deactivate a role bundle. | core/organisation/application |
| `authorisation.role_permission.assign` | Add a permission to a role. | core/organisation/application |
| `authorisation.role_permission.remove` | Remove a permission from a role. | core/organisation/application |
| `authorisation.role_permission.read` | Read role-permission mappings. | core/organisation/application |
...
| `authorisation.delegation.manage` | Manage delegated administration limits. | core/organisation/application |
| `authorisation.catalog.seed` | Seed or reconcile orchestrator route permission catalogs. | service/platform |
| `authorisation.audit.read` | Read authorisation audit events. | core/organisation/application |
