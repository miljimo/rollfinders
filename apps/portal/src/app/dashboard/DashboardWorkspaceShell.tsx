...
import { FounderAnalyticsTables } from "./FounderAnalyticsTables";
...
import { DashboardBadge as Badge } from "./components/DashboardBadge";
import { DialogInfo, ProfileInfo } from "./components/DashboardInfo";
...
function FounderAnalyticsPanel({
  ...
  return (
    ...
    >
      ...
      <FounderAnalyticsTables dailyVisits={dailyVisits} rows={rows} />
    </section>
  );
}
