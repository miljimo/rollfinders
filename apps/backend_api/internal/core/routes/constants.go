...
const (
	...
	AccountDeletionRequestsSelf          GatewayTargetPath = "/v1/account-deletion-requests/self"
	AccountDeletionRequestsEmail         GatewayTargetPath = "/v1/account-deletion-requests/email"
	AccountDeletionRequestsConfirm       GatewayTargetPath = "/v1/account-deletion-requests/confirm"
	AccountDeletionRequestsCurrent       GatewayTargetPath = "/v1/account-deletion-requests/current"
	AccountDeletionRequestsCurrentCancel GatewayTargetPath = "/v1/account-deletion-requests/current/cancel"
	...
	UsersUserIdTemporaryPassword         GatewayTargetPath = "/v1/users/{userId}/temporary-password"
	...
	PermissionUserPasswordSetTemporary GatewayPermissionName = "user.password.set_temporary"
...
func GatewayResourceCatalog() map[GatewayPermissionName]GatewayResourceDefinition {
	return map[GatewayPermissionName]GatewayResourceDefinition{
		...
		PermissionUserPasswordSetTemporary:           createGatewayResource(PermissionUserPasswordSetTemporary, UsersUserIdTemporaryPassword),
