...
* `apps/backend_api/internal/services/courses/docs/prds/proposal.md`
* `apps/backend_api/internal/services/payments/docs/prds/proposal.md`
* `apps/backend_api/internal/services/payments/docs/architecture/ArchitectureReview.md`
* `apps/backend_api/internal/services/payments/docs/tickets/feature/Tickets/Refinement/Readme.md`
* `apps/backend_api/internal/services/payments/docs/README.md`
* `apps/backend_api/internal/services/users/docs/prds/Reviewing/UserAndAuthGoServicePortPrd.md`
* `apps/backend_api/internal/services/payments/migrations/001_core_schema.sql`
* `apps/backend_api/internal/services/users/migrations/001_core_schema.sql`
* `services/payments/compose.yml`
* `services/users/compose.yml`
* `compose.yml`
* `scripts/cicd/run-service-sql-migrations.sh`
* `apps/backend_api/internal/services/courses/docs/prds/Reviewing/CourseCreationAndManagementPrd.md`
* `apps/backend_api/internal/services/courses/docs/tickets/README.md`
...
* OpenAPI 3 contract under `apps/backend_api/internal/services/courses/docs/api/OpenApi.yaml`
