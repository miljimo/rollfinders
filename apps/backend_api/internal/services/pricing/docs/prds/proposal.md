...
Create `apps/backend_api/internal/services/pricing/migrations/` with the `pricing` schema, `pricing_policies`, `outbox_events`, default seed policy, and MVP stored functions.
