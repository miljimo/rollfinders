...
func New(opts Options) (http.Handler, func() error, error) {
	...
	mustHandle(gatewayroutes.AccountDeletionRequestsSelf.String(), []string{http.MethodPost}, s.createSelfAccountDeletionRequest, auth)
	mustHandle(gatewayroutes.AccountDeletionRequestsEmail.String(), []string{http.MethodPost}, s.createEmailAccountDeletionRequest, auth)
	mustHandle(gatewayroutes.AccountDeletionRequestsConfirm.String(), []string{http.MethodPost}, s.confirmAccountDeletionRequest, auth)
	mustHandle(gatewayroutes.AccountDeletionRequestsCurrent.String(), []string{http.MethodGet}, s.currentAccountDeletionRequest, auth)
	mustHandle(gatewayroutes.AccountDeletionRequestsCurrentCancel.String(), []string{http.MethodPost}, s.cancelAccountDeletionRequest, auth)
	...
	mustHandle(gatewayroutes.UsersUserIdTemporaryPassword.String(), []string{http.MethodPost}, s.setAdminTemporaryPassword, auth)
