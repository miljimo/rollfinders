...
All mutation routes in this PRD SHALL be backed by PostgreSQL stored procedures in `apps/backend_api/internal/services/users/migrations/procedures`, following the payment service database pattern.
