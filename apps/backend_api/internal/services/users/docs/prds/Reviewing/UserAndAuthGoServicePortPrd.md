...
The exact endpoint contracts are defined in sibling service docs:
...
apps/backend_api/internal/services/users/migrations/schema/
apps/backend_api/internal/services/users/migrations/types/
apps/backend_api/internal/services/users/migrations/tables/
apps/backend_api/internal/services/users/migrations/functions/
apps/backend_api/internal/services/users/migrations/procedures/
```
