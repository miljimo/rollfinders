CREATE OR REPLACE FUNCTION organisations_list(p_limit integer DEFAULT 10, p_offset integer DEFAULT 0)
RETURNS TABLE (
    id text,
    name text,
...
CREATE OR REPLACE FUNCTION sessions_list(p_user_id text, p_limit integer DEFAULT 10, p_offset integer DEFAULT 0)
RETURNS TABLE (
    id text,
    user_id text,
    device_id text,
