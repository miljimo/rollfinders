...
* Tables in `apps/backend_api/internal/services/payments/migrations/tables`
* Types in `apps/backend_api/internal/services/payments/migrations/types`
* Functions in `apps/backend_api/internal/services/payments/migrations/functions`
* Procedures in `apps/backend_api/internal/services/payments/migrations/procedures`
* Schema changes in `apps/backend_api/internal/services/payments/migrations/schema`
