# API Gateway Service Docs

This folder contains documentation owned by the API gateway service. Shared platform, deployment, UI, and cross-service docs remain under `/docs`.
