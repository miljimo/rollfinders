...
import (
	...
	"rollfinders/internal/services/notification/handlers"
)
...
func (s *server) listNotifications(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, ListNotificationsResponse{Notifications: summaries, Pagination: pagination(filter.Limit, filter.Offset, len(summaries))})
}
