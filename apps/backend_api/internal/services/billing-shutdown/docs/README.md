...
This folder contains documentation owned by the billing shutdown service. Shared platform, deployment, UI, and cross-service docs remain under `/docs`.
...
```sh
cd apps/backend_api/containers/billing-shutdown
