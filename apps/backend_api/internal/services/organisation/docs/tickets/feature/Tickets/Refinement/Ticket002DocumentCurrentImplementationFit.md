...
- Documentation reviewer SHALL cross-check:
  ...
  - `apps/backend_api/internal/services/users/migrations/tables/003_organisations.sql`
  - `apps/backend_api/internal/services/users/migrations/tables/004_user_roles_and_permissions.sql`
