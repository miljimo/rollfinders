...
- `apps/backend_api/internal/services/authorisation/docs/testing/migrated-role-guard-areas.json`
...
1. Add its path to `apps/backend_api/internal/services/authorisation/docs/testing/migrated-role-guard-areas.json`.
